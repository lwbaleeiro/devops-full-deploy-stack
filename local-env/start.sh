...
echo ""
echo "--------------------------------------------------------"
echo "All set! To run Terraform, you'll need to configure"
echo "the environment variables in your current terminal session."
echo ""
echo "Run the command below in the root folder or in acme-iac-platform:"
echo ""
echo "  export SSL_CERT_FILE=\"\$(pwd)/floci-cert.pem\" && set -a && source .env && set +a"
echo "--------------------------------------------------------"
